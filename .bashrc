...
export PS1='\[\e[1;38;5;88m\]$(__awsenv_ps1 2>/dev/null)\[\e[1;38;5;40m\][ \t ] \[\e[1;38;5;099m\]\H:\[\e[1;38;5;40m\]\w\[\e[1;38;5;39m\]$(__git_ps1 " (%s)" 2>/dev/null)\[\e[1;38;5;099m\]\$ \[\e[0m\]'
...
alias grep='LANG=C grep --color=auto --exclude-dir .git --exclude-dir .terraform'
...
alias ssh='LC_ALL=C ssh -o ConnectTimeout=10 -o HashKnownHosts=no -o ForwardAgent=yes -o ServerAliveInterval=60'
alias sudo='sudo '
alias sd='sudo -Es'
